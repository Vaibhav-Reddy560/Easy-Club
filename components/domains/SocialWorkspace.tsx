    ...
    <div className="space-y-12">
      ...
      <div className="flex items-center gap-4 bg-black/40 p-2 rounded-2xl border border-white/5 w-fit">
        <button
          ...
          className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all ${activeTab === 'radar' ? 'bg-gold-500 text-black shadow-lg shadow-gold-500/10' : 'text-white'}`}
        >
          <Radio className="w-3 h-3" /> Talent Radar
        </button>
        <button
          onClick={() => setActiveTab('proposals')}
          className={`px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-all ${activeTab === 'proposals' ? 'bg-gold-500 text-black shadow-lg shadow-gold-500/10' : 'text-white'}`}
        >
      ...
      <AnimatePresence mode="wait">
        {activeTab === 'radar' ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
            exit={{ opacity: 0, x: 20 }}
            className="bg-zinc-900/40 border border-white/5 rounded-[3rem] p-8 md:p-12 space-y-12 shadow-2xl relative overflow-hidden"
          >
                ...
                >
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center gap-5">
                      <div className="w-14 h-14 rounded-2xl bg-zinc-1050 flex items-center justify-center border border-white/10 group-hover:border-gold-500/30 shadow-inner group-hover:scale-110 transition-transform duration-500">
                  ...
                  <a
                    ...
                    className="mt-8 w-full bg-zinc-950 border border-zinc-800 text-[10px] uppercase font-black tracking-[0.2em] py-4 rounded-2xl flex items-center justify-center gap-3 group-hover:bg-gold-500 group-hover:text-black transition-all group-hover:border-transparent"
                  >
